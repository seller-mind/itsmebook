      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>确保故事中使用的孩子信息（如名字）不会泄露孩子隐私</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <h3 className="font-semibold text-gray-800">1. 基础信息（可选）</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>名字/昵称：</strong>用于故事中的角色命名，不必须提供真实姓名</li>
                <li><strong>年龄（可选）：</strong>用于生成适龄的故事内容</li>
                <li><strong>性别（可选）：</strong>用于生成更准确的绘本内容</li>
              </ul>

              <h3 className="font-semibold text-gray-800">2. 使用行为信息</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>故事主题选择偏好</li>
                <li>使用频率和使用时长</li>
              </ul>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4 text-green-600">
                ...
                <li><strong>我们不收集儿童面部识别信息</strong></li>
                <li><strong>我们不收集精确地理位置</strong></li>
                <li><strong>我们不收集学校信息</strong></li>
              </ul>

              <p className="bg-yellow-50 p-4 rounded-xl border border-yellow-200 mt-4">
                <strong>💡 隐私保护提示：</strong>您可以使用昵称或代号代替真实姓名，我们不会验证孩子名字的真实性。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <strong>重要说明：</strong>本服务由家长录制自己的声音，而非儿童的声音。声音录制功能面向18岁以上成年人。
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>声音由家长录制，用于生成孩子专属的睡前故事</li>
                <li>声音数据仅用于本次故事生成，不会用于训练AI模型</li>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <p className="bg-yellow-50 p-4 rounded-xl border border-yellow-200 mt-4">
                <strong>⚠️ 数据跨境传输说明：</strong>儿童的姓名信息将通过互联网传输至新加坡存储。我们已按照《个人信息保护法》相关规定与Supabase签署数据处理协议（DPA），Supabase已通过SOC 2 Type II、ISO 27001等国际安全认证。如您不同意数据跨境传输，请勿让孩子使用本服务。
              </p>

              <h3 className="font-semibold text-gray-800">2. 存储期限</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>姓名/偏好信息：</strong>账户存续期间持续保存，可随时删除</li>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>加密存储：</strong>敏感个人信息采用AES-256加密存储</li>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>拒绝提供名字：</strong>故事将使用默认角色名"小宝贝"</li>
                <li><strong>拒绝提供年龄信息：</strong>我们将使用默认年龄生成故事</li>
                <li><strong>拒绝同意本政策：</strong>您的孩子将无法使用本服务</li>
              </ul>
              <p className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                <strong>💡 提示：</strong>所有信息均为可选，不提供真实信息不影响使用。您可以随时撤回同意，但撤回前我们基于同意进行的处理行为不受影响。如需撤回同意，请联系我们。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>联系客服：</strong>发送邮件至 <a href="mailto:haimozhouqiu@outlook.com" className="text-primary-orange hover:underline">haimozhouqiu@outlook.com</a>，说明需要更正的内容</li>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>联系客服：</strong>发送邮件至 <a href="mailto:haimozhouqiu@outlook.com" className="text-primary-orange hover:underline">haimozhouqiu@outlook.com</a>，主题注明"儿童信息删除申请"</li>
              </ul>
