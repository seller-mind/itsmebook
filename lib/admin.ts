 ...
 * Admin 模式工具 - 是我呀
 * 根据访问路径自动判断模式：
 *   /admin 或 /admin/* → admin 模式（全功能，仅自用）
 *   其他路径 → public 模式（对外版，零敏感数据）
 ...
 * 
 * 判断逻辑：
 * 1. 客户端：根据访问路径判断，/admin 开头即为 admin 模式
 * 2. 服务端：优先用环境变量
 * 3. 本地开发：可通过 NEXT_PUBLIC_APP_MODE=admin 切换
 */
export function getAppMode(): 'admin' | 'public' {
  ...
  // 客户端：根据路径判断，/admin 开头即为 admin 模式
...
export const ADMIN_PLANS: PlanConfig[] = [
  {
    ...
    name: '基础版',
    emoji: '📖',
    description: '8页AI绘本+PDF',
    price: 0,
    features: ['8页AI绘本', '高清PDF下载'],
    pageCount: 8,
    hasVoiceover: false,
  ...
  },
  {
    ...
    name: '精品版',
    emoji: '✨',
    description: '12页精品绘本+PDF',
    price: 29,
    features: ['12页AI绘本', '高清PDF下载'],
    pageCount: 12,
    hasVoiceover: false,
    hasParentVoice: false,
    hasChildHero: false,
  ...
  },
  {
    ...
    name: '有声版',
    emoji: '🎧',
    description: '有声绘本视频+PDF',
    price: 49,
    features: ['12页AI绘本', 'AI配音朗读视频', '高清PDF下载'],
    pageCount: 12,
    hasVoiceover: true,
    hasParentVoice: false,
    hasChildHero: false,
  ...
  },
  {
    ...
    name: '亲子朗读版',
    emoji: '👨‍👧',
    description: '家长声音朗读视频+PDF',
    price: 99,
    features: ['12页AI绘本', '家长声音克隆朗读', '配音视频', '高清PDF下载'],
    pageCount: 12,
    hasVoiceover: true,
    hasParentVoice: true,
    hasChildHero: false,
  ...
  },
  {
    ...
    name: '孩子主角专属版',
    emoji: '👶',
    description: '孩子照片生成主角+PDF',
    price: 129,
    features: ['12页AI绘本', '孩子照片生成主角', '高清PDF下载'],
    pageCount: 12,
    hasVoiceover: false,
    hasParentVoice: false,
    hasChildHero: true,
  ...
  },
  {
    ...
    price: 169,
    features: ['12页AI绘本', '自定义故事需求', '高清PDF下载'],
    pageCount: 12,
    hasVoiceover: false,
    hasParentVoice: false,
    hasChildHero: false,
