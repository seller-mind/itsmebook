...
export const STYLE_CONFIGS: Record<string, { 
  ...
  watercolor: {
    chinese: "专业水彩绘本风格，柔和的水洗效果，精致的笔触，温柔的色调，灵感来自经典英式水彩绘本",
    chinesePrompt: "专业儿童绘本插画，水彩画风格，柔和的水洗效果，细腻的笔触，温暖的色调，肌理丰富可见，有纸张纹理，柔和的光影，温馨雅致，手绘质感，没有塑料光滑感，艺术品质"
  },
  oil: {
  ...
  anime: {
    chinese: "经典日式动画绘本风格，温暖光影，精致背景，生动角色，治愈系",
    chinesePrompt: "专业儿童绘本插画，经典日式动画风格，温暖的金色时光效果，精致细腻的自然背景，表情丰富的角色，手绘水彩感，没有塑料3D渲染感，艺术品质"
  },
  chinese: {
    chinese: "中国传统水墨绘本风格，宣纸质感，淡雅笔墨，含蓄留白，灵感来自经典中国动画绘本",
    chinesePrompt: "专业儿童绘本插画，传统中国水墨画风格，宣纸质感，优雅流畅的笔触，细腻的墨色晕染从浓到淡，含蓄的留白，赭红色点缀，米黄色背景，经典中国水墨绘本风格，手绘质感，艺术品质"
  },
  pastoral: {
    chinese: "温暖田园绘本风格，金色光线，柔和阴影，田园牧歌氛围，灵感来自经典英式乡村绘本",
    chinesePrompt: "专业儿童绘本插画，温暖的田园水彩风格，金色的时光效果，柔和的长阴影，温馨的英式乡村氛围，茅草屋顶小屋和花园，可见的水彩纹理和纸张颗粒，经典英式乡村绘本风格，手绘质感，艺术品质"
  },
  fantasy: {
    chinese: "梦幻童话绘本风格，如梦似幻的氛围，虹彩色调，魔法光影，灵感来自经典奇幻绘本",
    chinesePrompt: "专业儿童绘本插画，梦幻童话现实主义风格，如梦似幻的氛围，漂浮的光粒子，彩虹般闪烁的色彩，魔法光影与可见光线，经典奇幻绘本风格，手绘质感带微妙魔法光晕，没有塑料光滑感，艺术品质"
  },
  minimalist: {
    chinese: "现代简约绘本风格，大胆几何造型，有限色彩，干净构图，灵感来自现代简约绘本大师",
    chinesePrompt: "专业儿童绘本插画，现代简约风格，大胆干净的几何形状，有限的3-4种色彩调色板，慷慨的留白，平面设计带微妙肌理，现代简约绘本风格，干净优雅的构图，手工质感，艺术品质"
  },
  nordic: {
    chinese: "北欧经典绘本风格，简洁线条，柔和冷色调，温馨极简",
    chinesePrompt: "专业儿童绘本插画，北欧斯堪的纳维亚风格，简洁温柔的墨线带水彩晕染，柔和的冷色调带温暖点缀，温馨的极简氛围，可见的手绘线条质感，手绘质感，艺术品质"
  }
};
...
要求：1)不说教，道理藏在故事里 2)1-2页建立日常与困境，3-12页冒险冲突（多段递进），13-17页深入危机与高潮，18-19页转折，20页温暖收尾 3)每页10-50字，优美凝练适合朗读 4)主角外貌所有页面一致 5)构图多样：远景/中景/特写/俯视/仰视交替 6)严禁模仿、借鉴或引用任何已有IP角色（如迪士尼、漫威、动漫等），所有角色和场景必须完全原创。

输出JSON：
{"title":"标题5字内","appearanceChinese":"外貌描述(发型脸型眼睛肤色穿着)","pages":[{"pageNumber":1,"text":"中文10-50字","imagePrompt":"[外貌描述，与appearanceChinese一致], [动作表情], [场景前景中景背景], [氛围情绪], [光影], [构图], {wanchineseStyle}, 专业儿童绘本插画，手绘质感，温暖自然光，无多余手指，比例正确，角色一致，完全原创角色不模仿任何已有IP"}]}`;
